      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 sm:p-6 border-2 border-blue-200">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className={`inline-flex items-center px-3 sm:px-4 py-2 rounded-lg font-semibold text-sm sm:text-base ${getStatusClasses(currentStatusConfig.color)}`}>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border-2 border-gray-200 overflow-visible">
            <button
              ...
              className="w-full flex items-center justify-between p-4 sm:p-6 hover:bg-gray-50 transition rounded-xl"
            >
            ...
            {showJobDetails && (
              <div className="px-4 sm:px-6 pb-4 sm:pb-6 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  {/* Scheduled Date - FIXED FOR MOBILE */}
                  ...
                  {/* Scheduled Time - FIXED FOR MOBILE */}
                  <div className="relative z-20">
                    <label className="block text-sm font-semibold text-gray-700 mb-2">
                      Scheduled Time
                    </label>
              ...
              <div className="px-4 sm:px-6 pb-4 sm:pb-6 space-y-4">
                    ...
                    <div className="bg-blue-50 rounded-lg p-3 sm:p-4 border border-blue-200">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-4">
                        <input
                          ...
                          className="sm:col-span-2 px-3 py-2 rounded border border-gray-300 focus:border-blue-500 focus:outline-none text-sm sm:text-base"
                        />
                        <input
                          type="number"
                          step="0.01"
                          ...
                          placeholder="Amount"
                          className="px-3 py-2 rounded border border-gray-300 focus:border-blue-500 focus:outline-none text-sm sm:text-base"
                        />
                      </div>
                      <button
                ...
                {quoteData.length === 0 && !showQuoteBuilder && (
                  <div className="text-center py-6 sm:py-8">
                    ...
                    <button
                      onClick={() => setShowQuoteBuilder(true)}
                      className="bg-green-600 hover:bg-green-700 text-white font-semibold px-4 sm:px-6 py-2 rounded-lg transition text-sm sm:text-base"
                    >
                      ➕ Create Quote
                    </button>
                  </div>
            ...
            {showPayment && (
              <div className="px-4 sm:px-6 pb-4 sm:pb-6 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:outline-none bg-white text-gray-900 text-sm sm:text-base"
                    >
                ...
                <button
                  ...
                  disabled={saving}
                  className="w-full bg-green-600 hover:bg-green-700 disabled:bg-gray-400 text-white font-semibold py-3 rounded-lg transition text-sm sm:text-base"
                >
