...
export default function ProjectSection({ lead, currentUser, onRefresh, statusOptions, onUpdateStatus }: ProjectSectionProps) {
  ...
  const [showQuoteAndPayment, setShowQuoteAndPayment] = useState(false);
      ...
      {hasProject && (
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border-2 border-green-200">
          <button
            ...
            className="w-full flex items-center justify-between p-4 sm:p-6 hover:bg-green-50/50 transition rounded-xl"
          >
            <div className="flex items-center gap-3">
              <h3 className="text-base sm:text-lg font-bold text-gray-900">📄 Project Documents</h3>
            ...
            <span className={`text-2xl transition-transform ${showDocuments ? 'rotate-180' : ''}`}>
              ▼
            </span>
          </button>
            ...
            <div className="px-4 sm:px-6 pb-4 sm:pb-6 space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    value={docType}
                    onChange={(e) => setDocType(e.target.value as 'contract' | 'invoice' | 'permit' | 'other')}
                    disabled={uploadingDocs}
                    className="w-full px-4 py-2 rounded-lg border-2 border-gray-300 focus:border-green-500 focus:outline-none bg-white text-gray-900 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <option value="contract">📋 Contract</option>
                    <option value="invoice">💰 Invoice</option>
                    <option value="permit">🏛️ Permit</option>
                ...
                <div>
                  ...
                  <label
                    ...
                    className={`w-full flex items-center justify-center gap-2 px-6 py-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-green-500 transition cursor-pointer ${
                      uploadingDocs ? 'opacity-50 cursor-not-allowed' : 'hover:bg-green-50'
                    }`}
                  >
                    <span className="text-2xl">📄</span>
                    <span className="font-semibold text-gray-700">
                      {uploadingDocs ? '⏳ Uploading...' : 'Import Documents'}
                    </span>
                  </label>
                  <p className="text-xs text-gray-500 mt-2 text-center">
                    Click to select files • PDF, DOC, DOCX, TXT, XLS, XLSX • Max 15MB each
                  </p>
                </div>
              ...
              {documents.length > 0 ? (
                <div className="space-y-3 pt-6 border-t-2 border-green-200">
                  <h4 className="text-sm font-bold text-gray-900">Uploaded Files</h4>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between gap-2 mb-1">
                              <h5 className="font-semibold text-gray-900 text-sm truncate group-hover:text-green-600 transition">
                                {doc.name}
                              </h5>
                ...
                <div className="text-center py-6 text-gray-500 border-t-2 border-green-200 pt-6">
