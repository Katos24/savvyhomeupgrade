...
<th className="text-right px-5 py-3 text-xs font-medium text-gray-400 w-24">Qty</th>
   ...
   <tbody>
      {isEditing && quoteData.length > 0 && (
        <tr>
          <td colSpan={5} className="px-5 py-2 border-b border-dashed border-gray-200">
            <button
              onClick={() => setQuoteData([{ id: Date.now(), description: '', quantity: 1, unitPrice: 0, amount: 0 }, ...quoteData])}
      ...
      {isEditing ? (
        <>
          ...
          <motion.button whileTap={{ scale: 0.97 }}
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-black uppercase tracking-widest transition disabled:opacity-40"
          >
        ...
        <>
          ...
          <motion.button whileTap={{ scale: 0.97 }}
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest transition hover:bg-blue-500 disabled:opacity-30 disabled:cursor-not-allowed"
          >
