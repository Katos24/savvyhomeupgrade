        ...
        {success ? (
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500 text-base max-w-sm mx-auto">
              We've received all your information and will be in touch with you shortly.
            </p>
          ...
          <>
            {/* ── Header ── */}
            <div className="bg-gradient-to-r from-blue-600 to-blue-500 rounded-t-2xl px-6 py-5 text-white">
              ...
              <p className="text-blue-100 text-sm mt-1">
                Add a few more details to help us give you a better quote.
              </p>
            </div>
...
/>
              ...
              <div>
                <label className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-3">
                  ...
                  Upload Photos or Videos (helps us quote faster)
                </label>
