...
function DailyBriefCard() {
  return (
    <div className="rounded-3xl overflow-hidden bg-white border-2 border-slate-900/10 shadow-sm h-full flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-1">
        <div className="rounded-2xl overflow-hidden border-2 border-slate-900/10">
          ...
          <div className="divide-y-2 divide-slate-900/5">
            {[
              { color: '#3b82f6', label: 'Scheduled today', value: '2 jobs',  sub: 'Torres · Kim'  },
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        {/* Header */}
        <div
          className="px-4 sm:px-6 mb-10 sm:mb-14"
          style={{
            opacity: visible ? 1 : 0,
        ...
        >
          ...
          <p className="text-center text-[10px] text-slate-400 font-semibold mt-2 uppercase tracking-widest">
            Swipe to explore
          </p>
        </div>
        ...
        {/* ── DESKTOP: 3-col grid ── */}
        <div
          className="hidden lg:grid grid-cols-3 gap-5 px-6"
          style={{
            opacity: visible ? 1 : 0,
