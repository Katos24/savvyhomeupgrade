    ...
    <section className="py-16 lg:py-24 overflow-hidden" style={{ background: '#0a0f1e' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="lg:hidden">
          <h2 className="text-3xl font-black text-white tracking-tight leading-[0.9] mb-8">
              ...
              <div key={i} className="border-b border-white/10">
                <button onClick={() => setActiveTab(i)} className="w-full text-left outline-none py-5">
                  <div className={`flex items-center gap-4 transition-opacity duration-200 ${isActive ? 'opacity-100' : 'opacity-35'}`}>
                    ...
                    <div className="flex-1">
                      <p className="text-[10px] font-black text-white/30 uppercase tracking-widest">{item.eyebrow}</p>
                      <h3 className="text-base font-black text-white">{item.title}</h3>
                    </div>
                    <div className="w-2 h-2 rounded-full shrink-0 transition-all"
                      style={{ background: isActive ? item.color : 'rgba(255,255,255,0.15)' }} />
                  </div>
                </button>
