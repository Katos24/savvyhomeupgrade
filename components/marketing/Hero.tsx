        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center pb-16 sm:pb-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-3 mb-8">
              ...
              <Link
                href="/demo"
                className="inline-flex items-center justify-center gap-2 text-white/70 hover:text-white font-semibold text-sm px-6 py-3 rounded-2xl border border-white/10 hover:border-white/20 bg-white/5 hover:bg-white/10 transition w-full sm:w-auto"
              >
                Try demo
              </Link>

              {/* TRUST (NOW PROPERLY PLACED UNDER CTA) */}
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 pt-2 text-[11px] font-bold text-white/30 uppercase tracking-widest">
