...
import { ArrowRight, CheckCircle2, Zap, Camera, BellRing, MousePointerClick } from 'lucide-react';
  ...
  return (
    <section className="relative bg-[#020617] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start pb-16 sm:pb-20">
          
          <div className="flex flex-col">
            
            {/* 1. HEADLINE BLOCK */}
            <div className="order-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 mb-6 backdrop-blur-md">
              ...
              <h1 className="font-black text-white leading-[0.95] tracking-tight mb-8" style={{ fontSize: 'clamp(2.2rem, 7vw, 5rem)' }}>
                Win jobs while{' '}
                <br className="hidden sm:block" />
                <span className="text-emerald-500 italic">you're in the field.</span>
              </h1>

              <p className="text-[15px] sm:text-xl text-slate-400 font-medium leading-relaxed mb-10 max-w-lg mx-auto lg:mx-0">
            ...
            {/* 2. MOBILE DEMO */}
            <div className="order-2 lg:hidden mb-12 transform scale-[1.01]">
            ...
            <div className="order-3">
              ...
              <div className="hidden sm:grid grid-cols-1 gap-5 mb-10 max-w-md mx-auto lg:mx-0">
                <div className="flex items-center gap-4 text-slate-300">
                  <div className="p-2.5 rounded-xl bg-white/5 border border-white/10 shrink-0"><MousePointerClick size={16} className="text-emerald-400" /></div>
                  <p className="text-sm font-bold text-slate-200 uppercase tracking-wide">
                    One Click Quote and Settlement Tracking
                  </p>
                </div>
                <div className="flex items-center gap-4 text-slate-300">
                  <div className="p-2.5 rounded-xl bg-white/5 border border-white/10 shrink-0"><Camera size={16} className="text-blue-400" /></div>
                  <p className="text-sm font-bold text-slate-200 uppercase tracking-wide">
                    Direct Photo and Video Job Briefs
                  </p>
                </div>
                <div className="flex items-center gap-4 text-slate-300">
                  <div className="p-2.5 rounded-xl bg-white/5 border border-white/10 shrink-0"><BellRing size={16} className="text-amber-400" /></div>
                  <p className="text-sm font-bold text-slate-200 uppercase tracking-wide">
              ...
              <div className="hidden sm:flex flex-wrap justify-center lg:justify-start items-center gap-x-5 gap-y-3 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">
        ...
        {/* ── BENTO METRICS ── */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 border border-white/10 rounded-xl sm:rounded-3xl overflow-hidden mb-16 sm:mb-20 shadow-2xl">
          {[
            ...
            <div key={i} className="bg-[#020617] px-3 py-6 sm:p-10 text-center hover:bg-white/[0.02] transition-colors">
        ...
        {/* ── STORY STRIP ── */}
        <div className="rounded-2xl sm:rounded-[4rem] overflow-hidden border border-white/5 bg-gradient-to-b from-white/[0.03] to-transparent mb-16 sm:mb-20">
