  ...
  return (
    <section className="relative bg-[#020617] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start pb-16 sm:pb-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="order-3">
              ...
              {/* FEATURES: ONE-CLICK ENERGY */}
              <div className="grid grid-cols-1 gap-5 mb-10 max-w-md mx-auto lg:mx-0">
                <div className="flex items-center gap-4 text-slate-300">
                  <div className="p-2 rounded-xl bg-white/5 border border-white/10 shrink-0"><MousePointerClick size={18} className="text-emerald-400" /></div>
                  <p className="text-xs sm:text-sm font-bold text-slate-200 uppercase tracking-wide">
                    One Click Quote and Settlement Tracking
                  </p>
                </div>
                <div className="flex items-center gap-4 text-slate-300">
                  <div className="p-2 rounded-xl bg-white/5 border border-white/10 shrink-0"><Camera size={18} className="text-blue-400" /></div>
                  <p className="text-xs sm:text-sm font-bold text-slate-200 uppercase tracking-wide">
                    Direct Photo and Video Job Briefs
                  </p>
                </div>
                <div className="flex items-center gap-4 text-slate-300">
                  <div className="p-2 rounded-xl bg-white/5 border border-white/10 shrink-0"><BellRing size={18} className="text-amber-400" /></div>
                  <p className="text-xs sm:text-sm font-bold text-slate-200 uppercase tracking-wide">
              ...
              {/* TRUST SIGNALS */}
              <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start items-center gap-4 sm:gap-6 text-[9px] sm:text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">
                ...
                <div className="flex items-center gap-2 text-slate-400"><ShieldCheck size={14} className="text-emerald-500" /> You Own Your Data</div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 border border-white/10 rounded-2xl sm:rounded-3xl overflow-hidden mb-20 shadow-2xl">
          {[
            ...
            <div key={i} className="bg-[#020617] p-6 sm:p-10 text-center hover:bg-white/[0.02] transition-colors">
              ...
              <p className="text-[8px] sm:text-[10px] font-bold text-slate-500 uppercase tracking-widest">{s.label}</p>
            </div>
          ))}
        </div>

        {/* ── STORY STRIP ── */}
        <div className="rounded-[2rem] sm:rounded-[4rem] overflow-hidden border border-white/5 bg-gradient-to-b from-white/[0.03] to-transparent mb-20">
          <div className="py-16 sm:py-32 px-4 sm:px-10">
            <HeroStoryStrip />
          </div>
        </div>
      </div>
