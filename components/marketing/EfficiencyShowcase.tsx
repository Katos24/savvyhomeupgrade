  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden w-full">
      ...
      <div className="divide-y divide-slate-50">
        {logs.map((log, i) => (
          <div key={i} className="flex items-center justify-between px-3 py-2.5 hover:bg-slate-50/50 transition-colors">
...
export default function OperationsShowcase() {
  const cards = [
    ...
    },
    {
      ...
      desc: 'Attach quote templates, tasks, and pipeline stages to each job type.',
