      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24 items-center">
          ...
          <div className="relative order-1 lg:order-2 group">
            ...
            <div className="relative rounded-[2rem] sm:rounded-[3.5rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-100 bg-slate-50">
              <img 
              ...
              {/* Floating Badge: HIDDEN ON MOBILE (hidden), SHOWS ON DESKTOP (sm:block) */}
              <div className="hidden sm:block absolute bottom-8 right-8 w-64 bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-white shadow-xl">
          ...
          <div className="flex flex-col order-2 lg:order-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-100 mb-6 sm:mb-8 self-start">
            ...
            <h2 className="font-black text-slate-900 tracking-[-0.04em] leading-[0.95] sm:leading-[0.9] mb-6 sm:mb-8" style={{ fontSize: 'clamp(2.2rem, 6vw, 4.5rem)' }}>
              Stop chasing leads. <br />
              <span className="text-emerald-600 italic">Start owning your time.</span>
            </h2>

            <p className="text-base sm:text-xl text-slate-600 font-medium leading-relaxed mb-8 sm:mb-10 max-w-xl">
              Your competitor is still texting quotes from his personal phone at 9:00 PM. 
              With Lead2Project, your business stays professional <span className="text-slate-900 font-bold">even when you’re off the clock.</span>
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 sm:gap-y-10 gap-x-8">
              <div className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h4 className="font-black text-slate-900 uppercase tracking-widest text-[10px]">Quiet Weekends</h4>
                </div>
              ...
              <div className="group">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h4 className="font-black text-slate-900 uppercase tracking-widest text-[10px]">Automated Reminders</h4>
                </div>
                <p className="text-slate-500 text-sm leading-relaxed">
