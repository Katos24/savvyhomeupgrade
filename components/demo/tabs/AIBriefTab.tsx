...
export default function AIBriefTab({ lead }: { lead: Lead }) {
      ...
      <div className="space-y-4">
        ...
        <div className="bg-indigo-50 border border-indigo-200 rounded-2xl p-4 flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-indigo-600">Photo analysis, urgency scoring, and next steps — all automatic.</p>
          </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      ...
      <p className="text-xs text-indigo-500 font-bold mb-6">See the Michael Johnson lead for a live example →</p>
