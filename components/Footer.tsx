        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/features" className="text-slate-400 hover:text-blue-400 transition text-sm">
                  Features
                </Link>
              </li>
              <li>
  ...
  <Link href="/contact" className="text-slate-400 hover:text-blue-400 transition text-sm">
    Contact
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/privacy" className="text-slate-400 hover:text-blue-400 transition text-sm">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-slate-400 hover:text-blue-400 transition text-sm">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/cookies" className="text-slate-400 hover:text-blue-400 transition text-sm">
                  Cookie Policy
                </Link>
              </li>
            </ul>
