...
const PLAN_HIGHLIGHTS = {
  ...
  Pro: [
    'Everything in Basic',
    'One-click quote, schedule, and reminder emails',
...
const FEATURE_TABLE: FeatureGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Invoice generation as PDF',          free: false, basic: false, pro: true  },
      { label: 'Send invoice email with payment link', free: false, basic: false, pro: true },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'Send payment reminder email',        free: false, basic: false, pro: true  },
