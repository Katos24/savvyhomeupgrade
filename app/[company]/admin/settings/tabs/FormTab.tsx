        ...
        <div className="space-y-6 pt-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200/80 p-6 lg:p-8 shadow-xs">
            ...
            <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
              {canUseCustomQuestions &&
                customQuestions.map((q) => (
                  <div key={q.id} className="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-3">
              ...
              {canUseCustomQuestions && (
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 rounded-xl border-2 border-dashed border-slate-200 bg-white px-4 py-3 text-xs font-bold text-slate-700 transition hover:border-slate-300 hover:bg-slate-50"
                >
            ...
            {!canUseCustomQuestions && (
              <div className="mt-2">
                <UpgradeNotice companySlug={company.slug} feature="Custom Intake Questions" />
              </div>
            )}
          </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4 backdrop-blur-xs" onClick={onCancel}>
      ...
      >
        <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
          ...
          <button onClick={onCancel} className="rounded-lg p-1 text-slate-400 transition hover:bg-slate-100 hover:text-slate-700">
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="space-y-4 p-5">
          <div>
            <label className="mb-1.5 block text-xs font-bold text-slate-800">Question Title</label>
            <input
              type="text"
              value={question.label}
              onChange={(e) => onChange({ ...question, label: e.target.value })}
              className="w-full rounded-lg border border-slate-200 px-3.5 py-2 text-xs font-medium text-slate-900 outline-none transition focus:border-slate-900"
          ...
          <div>
            <label className="mb-1.5 block text-xs font-bold text-slate-800">Answer Format</label>
            ...
            <div className="space-y-2 border-t border-slate-100 pt-3">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-medium outline-none focus:border-slate-900"
