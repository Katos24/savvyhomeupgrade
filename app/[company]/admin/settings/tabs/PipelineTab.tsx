              ...
              >
                ...
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <input
                    ...
                    className="flex-1 min-w-0 px-2 py-1 bg-transparent border-2 border-transparent hover:border-slate-300 focus:border-blue-500 rounded font-semibold text-slate-900 text-sm sm:text-base"
                  />
                </div>
                ...
                <div className="flex items-center gap-2 sm:gap-1">
                  ...
                  <button
                    ...
                    className="sm:opacity-0 sm:group-hover:opacity-100 p-2 text-red-600 hover:text-red-800 hover:bg-red-50 rounded-lg transition"
                    title="Remove status"
                  >
                    <X className="w-5 h-5" />
                  </button>
