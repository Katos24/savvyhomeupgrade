...
<p className="text-xs text-white/30 mt-1">PNG, JPG, SVG under 5MB — shows in emails and your booking page</p>
 ...
 {/* Email */}
        ...
        {currentStep === 2 && (
          <div className="space-y-6">
            ...
            <div className="text-center py-6">
             <div className="w-20 h-20 mx-auto mb-5 rounded-3xl flex items-center justify-center shadow-2xl shadow-emerald-600/40"
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl overflow-hidden">
              ...
              {/* Link + copy */}
                <div className="flex items-center gap-2">
                  <div className="flex-1 min-w-0 px-4 py-3 bg-white/5 border border-white/10 rounded-xl overflow-x-auto">                    <p className="text-xs sm:text-sm font-mono font-bold text-blue-300 whitespace-nowrap">{publicLink}</p>                  </div>
                  <button
                    ...
                    className={`shrink-0 flex items-center gap-2 px-4 py-3 rounded-xl font-black text-sm transition-all ${
                      copied ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30' : 'bg-emerald-600 hover:bg-emerald-500 text-white'
                    }`}
                  >
  ...
  href={`/${company.slug}/dashboard?onboarded=1`}
             className="w-full py-5 rounded-2xl text-white font-black text-base flex items-center justify-center gap-3 transition-all hover:opacity-90 active:scale-[0.98] shadow-2xl shadow-emerald-600/30"
              style={{ background: 'linear-gradient(135deg, #1a6645, #15803d)' }}
            >
              Open my dashboard
            ...
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl px-5 py-4 text-center">
              <p className="text-sm font-bold text-blue-300 leading-relaxed">
                You can update your pipeline, email templates, team members, and everything else in <span className="text-white font-black">Settings</span> anytime.
              </p>
            </div>
          </div>
        )}
